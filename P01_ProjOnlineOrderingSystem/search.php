...
<body class="app-page-background">
	...
	$bestSellerResultSet = $sqlHelper->executeQuery($connector->get_connection(), "select a.ProductID, a.header, b.ImgGalleryPath, b.price, b.unit from best_seller a, product b where a.withdrawn = 'N' and a.ProductID = b.id and b.displayName like '%".$_POST['productSearch']."%' and a.category in ('DESSERT', 'CUP', 'CREAM', 'CHOC', 'CHEESE', 'BROWNIES', 'BREAD')", []);
    ...
    <div class="container text-center">
    	<div class="row text-center">
        	<center><i>No result found. Please try another keyword.</i></center>
        </div>
    </div>
    <?php
    }
